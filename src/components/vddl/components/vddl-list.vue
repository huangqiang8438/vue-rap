...
export default {
  ...
  methods: {
    ...
    handleDragleave(event) {
      ...
      this.$emit('operate', this.operate)
    },
    ...
    getPlaceholderElement() {
      var oldPlaceholder = this.$el.parentNode.querySelectorAll('.vddl-placeholder')
      var placeholder = this.$el.parentNode.querySelectorAll('.vddl-placeholder')
